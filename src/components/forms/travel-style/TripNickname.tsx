// src/components/forms/travel-style/TripNickname.tsx
      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border-2 rounded-[10px] focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 text-primary bg-white placeholder-gray-500 font-raleway font-bold ${hasValidationError ? 'border-red-500' : 'border-primary'}`}
          />
        </div>
        ...
        <div className="space-y-4 pt-4 border-t border-gray-300">
          <div>
            <label className="block text-primary font-bold mb-2 font-raleway text-[25px]">
              Your Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-primary font-bold mb-1 font-raleway text-[25px]">
              Email
            </label>
            <p
